 ...
 * clutch/killshot dots. The rings are enlarged and spread out (68-unit bands,
 * outer r=430) so they read clearly on the projected feed, and each ring's
 * point value is drawn along the horizontal centre line marching in toward the
 * bullseye. Since Axe Classic has no killshot dots to leave room for, the outer
 * ring runs larger than the WATL/IATF boards.
 */
...
const AXE_CLASSIC_SPEC = {
  ...
  lineWidth: 7,
  discs: [
    { r: 430, points: 1, label: '1 ring' },
    { r: 362, points: 2, label: '2 ring' },
    { r: 294, points: 3, label: '3 ring' },
    { r: 226, points: 4, label: '4 ring' },
    { r: 158, points: 5, label: '5 ring' },
    { r: 90, points: 6, label: 'Bullseye', fill: BULLSEYE_RED },
  ],
  spots: [],
};
